...
public class BaseFactory {
	...
	private static String propertyFile = System.getProperty("user.dir")+File.separator+"profiles"+File.separator+"dev.properties";
	...
	public void driverInitialization() {
	    ...
	    //le -> local execution, he -> headless execution , ce -> containerize execution
